...
<table width="680" cellpadding="0" cellspacing="0"
  ...
  <tr><td style="background:#1a1a2e;padding:24px 32px;">
    <table width="100%" cellpadding="0" cellspacing="0">
      <tr>
        <td>
          <div style="color:#ffffff;font-size:11px;letter-spacing:2px;
                      text-transform:uppercase;margin-bottom:6px;">Daily Monitoring</div>
          <div style="color:#aaaacc;font-size:11px;margin-bottom:2px;">Built on trust.</div>
          <div style="color:#aaaacc;font-size:11px;margin-bottom:2px;">Powered by expertise.</div>
          <div style="color:#aaaacc;font-size:11px;">Led by operators.</div>
        </td>
        <td align="right" valign="middle">
          <span style="color:#ffffff;font-size:22px;font-weight:700;
                       letter-spacing:4px;">PARATAXIS</span>
          <div style="color:#aaaacc;font-size:11px;text-align:right;margin-top:4px;">{date_str}</div>
        </td>
      </tr>
    </table>
  </td></tr>
